(function () {
    ...
    angular
        ...
        .constant("en", {
            ...
            IngreseNombres: "Enter first name",
            IngreseApellidos: "Enter last name",
            IngreseNombreUsuario: "Enter user name",
            IngreseContrasena: "Enter password",
            IngreseDocumento: "Enter identification",
            //---------cuenta-----------------//
